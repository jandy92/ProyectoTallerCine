...
#
# Created: Mon Aug 31 12:58:06 2015
...
class Ui_crear_actor(object):
    def setupUi(self, crear_actor):
        ...
        self.imagen_label.setPixmap(QtGui.QPixmap("../ProyectoTallerCine/Actores/img/0.jpg"))
        ...
        self.check_hombre = QtGui.QCheckBox(self.centralWidget)
        self.check_hombre.setGeometry(QtCore.QRect(240, 180, 97, 22))
        self.check_hombre.setObjectName("check_hombre")
        self.check_mujer = QtGui.QCheckBox(self.centralWidget)
        self.check_mujer.setGeometry(QtCore.QRect(370, 180, 97, 22))
        self.check_mujer.setObjectName("check_mujer")
    ...
    def retranslateUi(self, crear_actor):
        ...
        self.check_hombre.setText(QtGui.QApplication.translate("crear_actor", "Hombre", None, QtGui.QApplication.UnicodeUTF8))
        self.check_mujer.setText(QtGui.QApplication.translate("crear_actor", "Mujer", None, QtGui.QApplication.UnicodeUTF8))
